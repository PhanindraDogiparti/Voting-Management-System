                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            foreach ($row as $column => $value) {
                                if($column == "image_url"){
                                    echo "<td><img src='" . $row['image_url'] . "' alt='' onclick='showImage(this)' width='200' height='100'></td>";
                            ...
                            if($row['vid'] != ""){
                                echo "<td><button style='background-color: green; color: white;'>Approved</button></td>";

                            }else
                            echo "<td><button onclick=\"location.href='approve.php?id=" . $row['id'] . "&mail={$row['email']}'\">Approve</button></td>";
